  ...
  // saving pose estimates and GPS signals
    ...
    void performLoopClosure()
    {
        ...
        *copy_cloudKeyPoses6D = *cloudKeyPoses6D;
        ...
        kdtreeHistoryKeyPoses.reset(new pcl::KdTreeFLANN<PointType>());
        kdtreeHistoryKeyPoses->setInputCloud(copy_cloudKeyPoses3D);
        kdtreeHistoryKeyPoses->radiusSearch(temporaryCloudKeyPoses3D->back()), historyKeyframeSearchRadius, pointSearchIndLoop, pointSearchSqDisLoop, 0);
        ...
        int loopKeyPre = pointSearchIndLoop[0];
