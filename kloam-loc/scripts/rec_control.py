...
distance=2.0  # m , the size of the rectangular trajectory
wControl=0.4 # angular speed control ,rad/s
degControl=90 # degrees, turning angle

pi=math.pi
minLineSpeed=0.2 # m/s
minAnguSpeed=0.2 # rad/s
baudrate = 19200
tty='/dev/ttyUSB0'
#tty='COM1'
bufferLen=21

# pro1: unable to clear odometry
# pro2: w is wrong
class SerialRW():
    controlstate=0;    
    START ='\xFF\x01'
