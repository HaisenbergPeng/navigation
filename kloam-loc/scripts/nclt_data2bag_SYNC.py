...
def main():
    record_time = '2012-11-16'
    
    root_dir = '/media/imr/BIGLUCK/Datasets/NCLT/datasets'
    save_dir = '/media/imr/BIGLUCK/Datasets/NCLT/datasets'
    ...
    if write_lidar_data:
        bag_name = os.path.join(save_dir, record_time, record_time+'2.bag')
    else:
